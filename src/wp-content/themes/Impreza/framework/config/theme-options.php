...
$misc['titlebars_description'] .= '<br><img src="' . $us_template_directory_uri . '/framework/admin/img/usof/l-titlebar.png">';
$misc['content_description'] .= '<br><img src="' . $us_template_directory_uri . '/framework/admin/img/usof/l-content.png">';
$misc['sidebars_description'] .= '<br><img src="' . $us_template_directory_uri . '/framework/admin/img/usof/l-sidebar.png">';
	...
	$pages_layout_config = array_merge(
		$pages_layout_config, array(
			...
			'content_' . $type . '_id' => array(
				...
				'std' => '__defaults__',
				// TODO: remove when WooCommerce support will be ready
				'classes' => in_array( $type, array( 'product', 'shop' ) ) ? 'hidden' : 'desc_3',
			),
	...
	$archives_layout_config = array_merge(
		$archives_layout_config, array(
			...
			'sidebar_tax_' . $type . '_pos' => array(
				...
				'classes' => 'for_above',
				'show_if' => array(
					array( 'sidebar_tax_' . $type . '_id', '!=', '__defaults__' ),
					'and',
					array( 'sidebar_tax_' . $type . '_id', '!=', '' ),
				),
			),
...
return array(
	'general' => array(
		...
		'fields' => array(
			...
			'search_page' => array(
				...
				'type' => 'select',
				'options' => us_array_merge(
					array( 'default' => '&ndash; ' . __( 'Show results via default Grid', 'us' ) . ' &ndash;' ), $us_page_list
				),
				'std' => 'default',
				'classes' => 'desc_3',
			),
		...
		'fields' => array_merge(
			array(
				...
				'content_archive_id' => array(
					...
					'type' => 'select',
					'options' => us_array_merge(
						array( '' => '&ndash; ' . __( 'Show results via default Grid', 'us' ) . ' &ndash;' ), $us_page_blocks_list
					),
					'std' => '',
					'classes' => 'desc_3',
				),
				...
				'sidebar_author_pos' => array(
					...
					'classes' => 'for_above',
					'show_if' => array(
						array( 'sidebar_author_id', '!=', '__defaults__' ),
						'and',
						array( 'sidebar_author_id', '!=', '' ),
					),
				),
	...
	'woocommerce' => array(
		...
		'fields' => array(
			...
			'shop_popup_width' => array(
				'title' => __( 'Popup Width', 'us' ),
				'description' => $misc['desc_width'],
				'type' => 'text',
				'std' => '',
				'show_if' => array(
					array( 'shop_listing_style', '=', 'custom' ),
					'and',
					array( 'shop_overriding_link', '=', 'popup_post' ),
				),
			),
			'shop_popup_arrows' => array(
