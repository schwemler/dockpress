...
return array(
	...
	'params' => array_merge( array(
		...
		'text_selection' => array(
			'switch_text' => __( 'Sharing via text selection', 'us' ),
			'description' => __( 'When you select text in the post content, a panel with buttons appears, and you can quickly share the selected text.', 'us' ),
			'type' => 'switch',
			'std' => FALSE,
		),
		'url' => array(
