...
return array(
	...
	// Pixels only
	'desc_pixels' => __( 'In pixels only.', 'us' ) . ' ' . sprintf( __( 'Examples: %s', 'us' ), '<span class="usof-example">32px</span>, <span class="usof-example">64px</span>, <span class="usof-example">128px</span>' ),
