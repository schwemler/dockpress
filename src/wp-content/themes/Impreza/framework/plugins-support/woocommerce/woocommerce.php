...
function us_grid_woocommerce_product_loop_start( $template ) {
	...
	$items_layout = us_get_option( 'shop_layout', 'blog_1' );
	...
	$us_grid_listing_post_atts = array(
		...
		'type' => 'grid',
		'is_widget' => FALSE,
		'overriding_link' => us_get_option( 'shop_overriding_link', 'none' ),
	);
	...
	$template_vars = array(
		...
		'overriding_link' => us_get_option( 'shop_overriding_link', 'none' ),
		'popup_width' => us_get_option( 'shop_popup_width', '' ),
		'popup_arrows' => us_get_option( 'shop_popup_arrows', TRUE ),
	);
