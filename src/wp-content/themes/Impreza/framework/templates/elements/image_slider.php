 ...
 *
 * @param $ids                 string Comma-separated list of image IDs (from media library)
 * @param $arrows             string Navigation arrows: 'always' / 'hover' / 'hide'
 * @param $nav                 string Additional navigation: 'none' / 'dots' / 'thumbs'
 * @param $transition         string Transition effect: 'slide' / 'crossfade'
 * @param $autoplay             bool Enable auto-rotation?
 * @param $autoplay_period     int Auto Rotation Interval (in seconds)
 * @param $fullscreen         bool Allow fullscreen view?
 * @param $orderby             string Elements order: '' / 'rand'
 * @param $img_size             string Images size: 'large' / 'medium' / 'thumbnail' / 'full'
 * @param $img_fit             bool How to fim an image: 'scaledown' / 'contain' / 'cover'
 * @param $style             string Images Style
 * @param $meta                 bool Show items titles and description?
