...
$tag = 'div';
$btn_html = '';
$link_atts = us_generate_link_atts( $link, $us_elm_context );
...
$front_inline_css['background-color'] = $front_bgcolor;
...
$back_inline_css['background-color'] = $back_bgcolor;
...
if ( $animation == 'cubeflip' ) {
	...
	$front_bgcolor = ( ! empty( $front_bgcolor ) ) ? $front_bgcolor : us_get_option( 'color_content_bg_alt' );
