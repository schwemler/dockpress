...
function blossom_fashion_customizer_theme_info( $wp_customize ) {
    ...
    $theme_info .= '</p><p>';
    $theme_info .= sprintf( __( 'Documentation Link: %1$sClick here.%2$s', 'blossom-fashion' ),  '<a href="' . esc_url( 'https://blossomthemes.com/blossom-fashion-documentation/' ) . '" target="_blank">', '</a>' );
    $theme_info .= '</p>';
