...
?>
 <div class="wrapper-info">
	...
	<div class="button-bg">
	<button class="tablink" onclick="openPage('Home', this, '')"><?php esc_html_e('Lite Theme Setup', 'advance-automobile'); ?></button>
	<button class="tablink" onclick="openPage('Contact', this, '')"><?php esc_html_e('Premium Theme info', 'advance-automobile'); ?></button>
	</div>
	<div id="Home" class="tabcontent tab1">
	  	...
	  	<div class="sec-button">
			...
			<a target="_blank" href="<?php echo esc_url( admin_url('customize.php') ); ?>"><?php esc_html_e('Start Customizing', 'advance-automobile'); ?></a>
		</div>
