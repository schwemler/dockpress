    ...
    <div class="footer-b">
		<div class="container">
            ...
            <?php
                ...
                echo '<a href="' . esc_url( 'https://blossomthemes.com/fashion-lifestyle-free-wordpress-theme/' ) .'" rel="nofollow" target="_blank">' . esc_html__( 'Blossom Themes', 'fashion-lifestyle' ) . '</a>.';                                
